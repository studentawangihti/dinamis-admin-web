<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div>
        <button class="btn btn-secondary btn-sm shadow-sm mr-2" data-toggle="modal" data-target="#trashModal">
            <i class="fas fa-trash-restore fa-sm text-white-50"></i> Recycle Bin (<?= count($deleted_users) ?>)
        </button>
...
<?php elseif($this->session->flashdata('error')): ?>
    <div class="alert alert-danger border-left-danger fade show" role="alert">
            ...
            <form action="<?= base_url('user/save') ?>" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <small class="text-danger" id="pass_note" style="display:none;">Kosongkan jika tidak ingin mengubah password.</small>
                        <small class="text-primary" id="pass_new_note" style="display:none;">Password wajib diisi untuk user baru.</small>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-striped table-bordered">
                    <thead>
                        <tr><th>ID Sampah</th><th>Username</th><th>Dihapus Oleh</th><th>Aksi</th></tr>
                    </thead>
                    <tbody>
...
<script>
    ...
    function showModal(mode) {
        if(mode == 'add') {
            ...
            $('#pass_note').hide();
            $('#pass_new_note').show();
            $('#password').attr('required', true); // Wajib pass
        }
    ...
    function editUser(data) {
        ...
        $('#pass_note').show();
        $('#pass_new_note').hide();
        $('#password').attr('required', false); // Tidak wajib pass
